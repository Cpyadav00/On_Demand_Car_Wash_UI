...
@Component({
  selector: 'app-profile-for-users',
  templateUrl: './profile-for-users.component.html',
  styleUrls: ['./profile-for-users.component.css']
})
export class ProfileForUsersComponent {
  constructor(
