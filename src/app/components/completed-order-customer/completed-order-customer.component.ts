...
@Component({
  selector: 'app-completed-order-customer',
  templateUrl: './completed-order-customer.component.html',
  styleUrls: ['./completed-order-customer.component.css']
})
export class CompletedOrderCustomerComponent {
